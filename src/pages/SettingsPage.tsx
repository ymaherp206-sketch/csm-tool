...
import { Plus, Trash2, Building2, Upload, Save } from 'lucide-react';
    ...
    <div className="p-6 lg:p-8 max-w-3xl mx-auto">
      ...
      <div className="space-y-6">
        ...
        <div className="card p-6">
          ...
          <div className="flex gap-2">
            <input
              ...
              value={newCSM}
              onChange={e => setNewCSM(e.target.value)}
              onKeyDown={e => { if (e.key === 'Enter') { e.preventDefault(); addCSM(); } }}
              placeholder="Add CSM name..."
            />
            <button onClick={addCSM} className="btn-secondary px-3">
              <Plus size={16} />
            </button>
          </div>
        </div>
        ...
        <div className="card p-6">
          ...
          <p className="text-slate-500 text-xs mb-4">All data is stored in your browser's localStorage. Clearing your browser data will erase everything.</p>
          <button
            onClick={() => {
